...
public class LogRecoveryTest extends LogTestUtility {
     ...
     */
    @Test
    @GradedTest(number="25.1", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="25.2", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="25.3", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="25.4", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="25.5", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="25.6", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="25.7", max_score=1.0, visibility="visible")
