...
public class LogRollbackTest extends LogTestUtility {
     ...
     */
    @Test
    @GradedTest(number="24.1", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="24.2", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="24.3", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="24.4", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="24.5", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="24.6", max_score=1.0, visibility="visible")
     ...
     */
    @Test
    @GradedTest(number="24.7", max_score=1.0, visibility="visible")
